...
fun WeatherPage(viewModel: WeatherViewModel){
    ...
    val keyoardController = LocalSoftwareKeyboardController.current
    ...
    Column(
        ...
        when(val result = weatherResult.value){
            ...
            NetworkResponses.Loading -> {
                CircularProgressIndicator()
            }
            is NetworkResponses.Success -> {
...
fun WeatherDetails(data : WeatherModel){
    Column(
        ...
        AsyncImage(
            ...
            contentDescription = "Condition Icons")
        ...
        Card {
            Column(
                ...
                Row (
                    ...
                    WeatherKey(key = "Participation", value = data.current.precip_mm+ " mm")
                }
                Row (
                    modifier = Modifier.fillMaxWidth(),
                    horizontalArrangement = Arrangement.SpaceAround
